...
function setupAds() {
    ...
    bigAd.innerHTML = adConfig.big.text[currentLang] ? `<img src="${adConfig.big.imageSrc}" alt="Big Ad" class="w-12 h-12 rounded"><span class="text-gray-700">${adConfig.big.text[currentLang]}</span>` : `<span class="text-gray-700">${translations[currentLang].no_ad || 'No ads!'}</span>`;
    ...
    smallAd.innerHTML = adConfig.small.text[currentLang] ? `<img src="${adConfig.small.imageSrc}" alt="Small Ad" class="w-8 h-8 rounded"><span class="text-gray-700 text-sm">${adConfig.small.text[currentLang]}</span>` : `<span class="text-gray-700 text-sm">${translations[currentLang].no_ad || 'No ads!'}</span>`;
